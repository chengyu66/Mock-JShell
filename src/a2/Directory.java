...
/**
 * The class represent the driectory. It has the ability as the directory in the
 * computer It collects the file and directory.
 */
public class Directory extends FileDirectory {
  ...
  /**
   * 
   * the constructor of Directory initialize the subItem.
   * 
   * @return None
   */
   ...
   * 
   * @param None
   * @return subItem The string list of all file and irectory under this
   *         directory.
   */
