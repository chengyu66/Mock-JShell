...
/**
 * Documentaiton that store the table contains Command strings maps to its
 * Documentation
 * 
...
public class Documentation {
  ...
  /**
   * method that set the map with hashmap of command string and its
   * documentation
   * 
   * @param map is a hashmap that map Command strings to Documentations
   * @return return None
