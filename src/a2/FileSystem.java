...
/**
 * The class has the ability to use the File and Directory Class to trace the
 * path and set and get the current Directory for the relative path.
 */
public class FileSystem {
  ...
  /**
   * The constructor of FileSystem initialize the root currentDirectory and
   * directoryStack
   * 
  ...
  /**
   * It has the ability to set the current Directory the current Directory is
   * relate to the relative path.
   * 
   * @param input a String array of user input without space
   * @return return None
   */
  ...
  /**
   * you pass in a path, FileSystem get to that directory need to consider the
   * case of File.
   * 
