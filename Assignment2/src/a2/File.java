...
/**
 * The class represents the file. It has the ability as what the file can do in
 * the computer It can collect the content
 */
public class File extends FileDirectory {
  ...
  /**
   * the constructor of file initialize content
   * 
